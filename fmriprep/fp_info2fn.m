function filename = fp_info2fn(info_struct, secstr, valuestr)
% filename = fp_info2fn(info_struct, secstr, valuestr)
%
...
% add the sep strings
values = cellfun(@(x) [x secstr], struct2cell(info_struct), 'uni', false);
fields = cellfun(@(x) [x valuestr], fieldnames(info_struct), 'uni', false);
