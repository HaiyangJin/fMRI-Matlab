...
% fscmd = fm_cmd2txt(outFn='fscmd.txt', outPath='~/Desktop/fscmd', varargin)
%
...
%
% Inputs:
%    outFn        <str> the filename of the output file. If path is
%                  included in outFn, outPath will be ignored. Default is
%                  'fscmd.txt'.
%    outPath      <str> the folder where outFn will be saved. Default is
%                  a folder called 'fscmd' in the Desktop folder.
%    varargin     all the to-be-saved fscmd (or cell strings).
%
% Output:
