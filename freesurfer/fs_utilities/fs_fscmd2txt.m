function fscmd = fs_fscmd2txt(outFn, outPath, varargin)
% fscmd = fs_fscmd2txt([outFn='fscmd.txt', outPath], varargin)
%
...
%
% Example:
% fscmd = fs_fscmd2txt('fscmd.txt', '~/Desktop/fscmd', fscmd_ana, fscmd_con, fscmd_avg);
%
