trimmedFor example, if you would like to only keep the vertices around a global maxima and their area size is say 100 mm<sup>2</sup>, you may use `fs_trimlabel()` to trim the label of interests.
