function fs_hcp_runlistfile(funcDir, strPattern, taskwc, taskNames)
% fs_hcp_runlistfile(funcDir, strPattern, taskwc, taskNames)
%
% This function reads the run_info.txt generated by fs_hcp_preproc and 
% creates the run list files.
% 
%
% Input:
%    funcDir       <str> path to the functional data folder. Default is
%                    "$FUNCTIONALS_DIR". 
...
cellfun(@(x) runlistfile(x, taskwc, taskNames), fullfile(funcDir, sessList, 'bold'), 'uni', false);
